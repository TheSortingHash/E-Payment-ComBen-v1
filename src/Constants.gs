...
var CONFIG_DEFAULTS = [
  ...
  { setting: 'dapLogoUrl',                           value: 'https://i.imgur.com/jaEbfAR.png',                                           notes: 'DAP logo image rendered at the top of every DAP-branded email (authorizer endorsement, payee notification). Update to swap branding.' },
  { setting: 'comBenSenderName',                     value: 'DAP ComBen E-Payment System',                                               notes: 'Display name on outgoing emails (MailApp `name`).' },
  { setting: 'comBenReplyTo',                        value: '',                                                                          notes: 'Reply-to address for authorizer and payee emails. Empty = recipients reply to the sending account. Set to a ComBen mailbox to route replies there.' },
